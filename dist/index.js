import { applyI18n, getInitialLang, setLang } from './i18n.js';
const state = {
    lang: getInitialLang(),
    view: 'play',
...
function navItem(view, key, icon) {
...
function gameCard(titleKey, desc, actionKey) {
    return `
    <div class="card">
...
function wireEvents() {
    ...
    // Placeholder actions
    document.querySelectorAll('button[data-action="open-game"]').forEach((btn) => {
